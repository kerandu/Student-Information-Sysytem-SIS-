...
public class ExamProcessing {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ExamProcessing window = new ExamProcessing();
	...
	private void initialize() {
		...
		frmExamProcessing.setTitle("Exam Processing");
		frmExamProcessing.setBounds(100, 100, 570, 525);
		frmExamProcessing.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
		...
		btnProcess.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int status=StudentDao.saveMarks(s);
		...
		lblAverage.setFont(new Font("Segoe UI", Font.PLAIN, 11));
